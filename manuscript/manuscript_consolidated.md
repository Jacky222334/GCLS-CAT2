...
**Methods**: We conducted a validation study of the German GCLS (G-GCLS) with 293 transgender and gender diverse participants (44.3% trans feminine, 14.3% non-binary, 16.7% trans masculine). Following rigorous translation procedures, we performed exploratory factor analysis and assessed psychometric properties including internal consistency, convergent validity, and clinical utility.
...
We recruited 293 transgender individuals (average age = 39.8 years, SD = 16.4). The sample consisted of 44.3% trans feminine, 14.3% non-binary, and 16.7% trans masculine. All participants were recruited from the University Hospital Zurich via a clinical records search using the ICD-10 code F64, which identifies gender identity-related diagnoses. Eligible individuals had received care between 2001 and 2021 in one of seven affiliated clinics (Richards et al., 2016).
...
**Subgroup Analysis of Female AMAB Participants:** A separate ESEM analysis was conducted for Female AMAB participants (n = 147) to examine the factor structure within this largest subgroup. Prior to this analysis, separate sampling adequacy assessments were performed. The Kaiser-Meyer-Olkin measure for the Female AMAB subgroup (KMO = .87) indicated excellent sampling adequacy, while Bartlett's test of sphericity remained significant (χ²(666) = 3428.12, p < .001). These values differ from the total sample KMO (.920) because they represent independent analyses on different datasets with varying sample sizes and correlation matrices.

The Female AMAB subgroup revealed an even more differentiated factor structure with comparable model fit indices (RMSEA = 0.051, 90% CI [0.044, 0.058]; TLI = 0.912; CFI = 0.928). This subgroup showed slightly higher internal consistency across most subscales: Social gender role recognition (alpha = .91), Genitalia (alpha = .89), Psychological functioning (alpha = .82), Chest (alpha = .87), Life satisfaction (alpha = .80), Physical and emotional intimacy (alpha = .86), and Other secondary sex characteristics (alpha = .83).
