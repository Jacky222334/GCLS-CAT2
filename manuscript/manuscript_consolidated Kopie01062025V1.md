...
: # (\caption{Heatmap of factor loadings...})
...
: # (\begin{figure}[h])
: # (\centering)
: # (\includegraphics[width=\textwidth]{figures/figure3_combined_fit_indices.pdf})
: # (\caption{Distribution and precision of fit indices...})
